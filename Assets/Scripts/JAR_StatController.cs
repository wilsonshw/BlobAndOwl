...
public class JAR_StatController : MonoBehaviour
{
    ...
    public float GetEffectiveDMG() 
    {
        ...
        {
            effectiveDMG = Mathf.RoundToInt(weaponSlot.r_magazine.dmg + weaponSlot.r_barrel.dmg + weaponSlot.r_grip.dmg +
    ...
    public float GetEffectiveCritRate()
    {
        ...
        if (weaponSlot.weaponType == "melee") //if melee weapon;
        {
            effectiveCrit = Mathf.RoundToInt(weaponSlot.m_pommel.critRate + weaponSlot.m_grip.critRate + weaponSlot.m_crossGuard.critRate + weaponSlot.m_blade.critRate);
        }

        if (weaponSlot.weaponType == "ranged") //if ranged weapon;
        {
            effectiveCrit = Mathf.RoundToInt(weaponSlot.r_magazine.critRate + weaponSlot.r_barrel.critRate + weaponSlot.r_grip.critRate +
    ...
    {
        return (Mathf.RoundToInt(weaponSlot.m_pommel.def + weaponSlot.m_grip.def + weaponSlot.m_crossGuard.def + weaponSlot.m_blade.def));
    }
    ...
    {
        return (Mathf.RoundToInt(weaponSlot.m_pommel.aoe + weaponSlot.m_grip.aoe + weaponSlot.m_crossGuard.aoe + weaponSlot.m_blade.aoe));
    }
    ...
    {
        return (Mathf.RoundToInt(weaponSlot.m_pommel.cooldown + weaponSlot.m_grip.cooldown + weaponSlot.m_crossGuard.cooldown + weaponSlot.m_blade.cooldown));
    }
